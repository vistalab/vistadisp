function LexDec_Experiment(subject, stim_list, practice_list, num_blocks, is_in_MEG, run_practice, ...
    ...
    use_sound_response, sound_trigger_volume, sound_response_time, is_debugging)
...
%
% Usage: See Run_LexDec_Experiment.m
%
% Stimulus Lists
...
PTBSetLogHeaders({'block_type','stim_list','id','answer','target'});    
    ...
    if run_practice
        ...
        for t = 1:length(practice_stims{1})
            PTBSetLogAppend(1,'clear',{'practice', practice_list, num2str(practice_stims{1}{t}{1}), practice_stims{1}{t}{2}, ...
                practice_stims{1}{t}{4}});
            if use_sound_response
                PTBSetAudioTriggerFileName(practice_stims{1}{t}{4});
            end
            [response start_time] = performTrial(start_time, practice_stims{1}{t}{4}, ...
                practice_stims{1}{t}{5}, practice_stims{1}{t}{6});
        ...
        for i = start_block:num_blocks
            ...
            for t = 1:length(block_stims{i})
                PTBSetLogAppend(1,'clear',{'experiment', stim_list, num2str(block_stims{i}{t}{1}), block_stims{i}{t}{2}, ...
                    block_stims{i}{t}{4}});                    
                if use_sound_response
                    PTBSetAudioTriggerFileName(block_stims{i}{t}{4},1);
                end
                [response start_time] = performTrial(start_time, block_stims{i}{t}{4}, ...
                    block_stims{i}{t}{5}, block_stims{i}{t}{6}); %#ok<ASGLU>
            end
...
function [response end_time] = performTrial(start_time, target_stim, f_trig, t_trig)
...
while 1
    ...
    [uniqueid condition item_num target f_trig t_trig] = ...
        strread(line,'%f%s%f%s%f%f','delimiter','\t'); %#ok<REMFF1>
    all_stims{end+1} = {uniqueid condition{1} item_num target{1} f_trig t_trig}; %#ok<AGROW>
end
fclose(fid);

%% Run_LexDec_Experiment: A file to run a lexical decision experiment with 
%   a prime before the decision word.
...
% Also, there is a PTBWrapper tutorial of sorts (unfortunately named
% Sample_Experiment.m, though this is NOT an experiment), that you can use
% to get acquainted with the PTBWrapper functions. This file lays out the
% basic commands for displaying stimuli to the screen. 
...
%   these variables.
stim_list = 'Stim_List_Prime.txt';
practice_list = 'Practice_List_Prime.txt';
...
% The time to show the prime
prime_time = 0.300;

% The time between the prime and the target
prime_ISI = 0.300;



% This line runs the experiment
LexDec_w_Prime_Experiment(subject_name, stim_list, practice_list, num_blocks, is_in_MEG, run_practice, ...
    ...
    use_sound_response, sound_trigger_volume, sound_response_time, prime_time, prime_ISI)

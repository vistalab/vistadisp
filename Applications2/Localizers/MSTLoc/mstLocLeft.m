...
%                   point-smoothing.
% 1/12/2010 jw      Added to vistadisp repository as is. 
%                   TODO: add GUI, make compatible with vistadisp tools
%                   (e.g., loadDisplayParams)
...
%     center = [rect(3)-max_d*ppd rect(4)/2];	% coordinates of screen center (pixels)
    center = [max_d*ppd rect(4)/2];	% coordinates of screen center (pixels)
%     fix_cord = [center-fix_r*ppd center+fix_r*ppd];
%     fix_cord = [[rect(3)-fix_r*ppd*2 rect(4)/2]-fix_r*ppd [rect(3)-fix_r*ppd*2 rect(4)/2]+fix_r*ppd];
    fix_cord = [center+[center_ecc*ppd 0]-fix_r*ppd center+[center_ecc*ppd 0]+fix_r*ppd];

function [resp, ok, figPos] = generalDialog(dlg, title, figPos)
%
% [resp, ok, figPos] = generalDialog(dlg, [title], [figPos])
%
...
for i = 1:nItems
    ...
    if ismember(dlg(i).style, {'edit' 'number' 'listbox' 'popup' 'text' 'filename'})

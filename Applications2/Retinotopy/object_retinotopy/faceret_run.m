function stim = faceret_run(scriptName, subject, varargin);
% stim = faceret_run([scriptName, subject, options]);
%
% Run a face bar retinotopy stimulus, based on a script.
%
% SEE: faceret_makescript, saveFaceBarImages, facebar.
%
% ras, 07/15/2008. 
if notDefined('scriptName')
	scriptName = 'facebar_noblanks_1.txt';
end
...
defColors = [1 1 1; 0 0 1; 1 0 1; 1 1 0; 1 0 0];

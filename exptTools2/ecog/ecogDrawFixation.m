function ecogDrawFixation(d, colIndex)
%
% drawEcogFixation(display, [colIndex=1])
%
...
%                 added 'lateraldots'
% 2010.01.06 AMR: ported from drawFixation to include photodiode rectangle at bottom right corner of screen
if nargin < 2,
    colIndex = 1;
end;
...
Screen(d.windowPtr,'FillRect', 0, d.trigRect); %  black rect for highest contrast trigger in lower right corner
return
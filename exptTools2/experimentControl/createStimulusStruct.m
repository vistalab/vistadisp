function stimulus = createStimulusStruct(img,cmap,seq,destRect,seqtiming,fixseq,diodeSeq, trigSeq)
...
%
if nargin < 6, fixseq       = []; end;
if nargin < 5, seqtiming    = []; end;
if nargin < 7, diodeSeq     = []; end
if nargin < 8, trigSeq      = []; end
